...
public class Servlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String ejbName = null;
        if (myEJB.getUserPrincipalFromEJBContext() != null) {
            ejbName = myEJB.getUserPrincipalFromEJBContext().getName();
        }

        response.getWriter().write("ejb username: " + ejbName + "\n");

        response.getWriter().write("ejb user has role \"foo\": " + myEJB.isCallerInRoleFromEJBContext("foo") + "\n");
        response.getWriter().write("ejb user has role \"bar\": " + myEJB.isCallerInRoleFromEJBContext("bar") + "\n");
        response.getWriter().write("ejb user has role \"kaz\": " + myEJB.isCallerInRoleFromEJBContext("kaz") + "\n");
        ...
        Set<String> roles = myEJB.getAllDeclaredCallerRoles();
